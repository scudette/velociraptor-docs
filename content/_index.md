...
menutitle = "Velociraptor"
date = 2021-06-09T02:33:37Z
weight = 5
chapter = false
+++

{{% notice "note" "What is Velociraptor?" %}}
...
<div style="font-size: xx-large">
  <a href="https://docs.velociraptor.app">
    Click here to view the Velociraptor Documentation Site
  </a>
</div>
...
* **Collection**: Apart from the usual Client/Server model,
  ...
  and [Hayabusa](https://docs.velociraptor.app/exchange/artifacts/pages/windows.eventlogs.hayabusa/)
...
* **Analysis**: Velociraptor offers a powerful interactive notebook
  ...
  [Timesketch](https://docs.velociraptor.app/artifact_references/pages/server.utils.timesketchupload/).

* **Exports**: Collected data can be conveniently exported to archives
  such as Zip file, automatically [backed up the cloud](https://docs.velociraptor.app/artifact_references/pages/server.utils.backups3/) or exported
  in real time to data lakes such as [Splunk](https://docs.velociraptor.app/artifact_references/pages/splunk.flows.upload/) or
  [Elastic](https://docs.velociraptor.app/artifact_references/pages/elastic.eventlogs.sysmon/).
...
3. Those practitioners on the front-line of incident response are more
   ...
   These are covered by the [playbooks](https://docs.velociraptor.app/training/playbooks/), and artifact references.
